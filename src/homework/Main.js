                        ...
                        <div className="row g-5 align-items-center">
                            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <p className="mb-4">
                                    ...
                                    No stet est diam rebum amet diam ipsum. Clita clita labore, dolor duo nonumy clita sit at, sed sit sanctus dolor eos, ipsum labore duo duo sit no sea diam.
                                    Et dolor et kasd ea. Eirmod diam at dolor est vero nonumy magna.
                                </p>
                            ...
                            <div className="col-lg-6 about-img wow fadeInUp" data-wow-delay="0.5s">
                                <div className="row">
                                    <div className="col-12 text-center">
                                        <img className="img-fluid w-75 rounded-circle bg-light p-3" src="homework/about-1.jpg" alt=""/>
                                    </div>
                                    <div className="col-6 text-start" style={{marginTop:"-150px"}}>
                                        <img className="img-fluid w-100 rounded-circle bg-light p-3" src="homework/about-2.jpg" alt=""/>
                                    </div>
                                    <div className="col-6 text-end" style={{marginTop:"-150px"}}>
                                        <img className="img-fluid w-100 rounded-circle bg-light p-3" src="homework/about-3.jpg" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row g-0">
                                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{minHeight:"400px"}}>
                                    <div className="position-relative h-100">
                                        <img className="position-absolute w-100 h-100 rounded" alt="" src="homework/call-to-action.jpg" style={{objectFit:"cover"}}/>
                                    </div>
                                </div>
                                        ...
                                        <form>
                                            <div className="row g-3">
                                                ...
                                                <div className="col-12">
                                                    <div className="form-floating">
                                                        <textarea className="form-control border-0" placeholder="Leave a message here" id="message" style={{height:"100px"}}/>
                                                        <label htmlFor="message">Message</label>
                                                    </div>
                                                </div>
                                                <div className="col-12">
                                                    <button className="btn btn-primary w-100 py-3" type="submit">Submit
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div className="row g-5">
                            <div className="col-lg-3 col-md-6">
                                ...
                                <div className="d-flex pt-2">
                                    <Link to="" className="btn btn-outline-light btn-social"><i className="fab fa-twitter"/></Link>
                                    <Link to="" className="btn btn-outline-light btn-social"><i className="fab fa-facebook-f"/></Link>
                                    <Link to="" className="btn btn-outline-light btn-social"><i className="fab fa-youtube"/></Link>
                                    <Link to="" className="btn btn-outline-light btn-social"><i className="fab fa-linkedin-in"/></Link>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6">
                            ...
                            <div className="col-lg-3 col-md-6">
                                ...
                                <div className="position-relative mx-auto" style={{maxWidth:"400px"}}>
                                    <input className="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email"/>
                                        <button type="button" className="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">SignUp
                                        </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="copyright">
                            <div className="row">
                                <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                                    <Link to="" className="border-bottom">Your Site Name</Link>
                                        , All Right Reserved. Designed By
                                    <Link to="" className="border-bottom">HTML Codex</Link>
                                        <br/>Distributed By:
                                    <Link to="" className="border-bottom" target="_blank">ThemeWagon</Link>
                                </div>
